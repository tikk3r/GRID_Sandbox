...
function runtaql(){
    ...
    FREQ=$( singularity exec -B /scratch,$PWD $SIMG echo "select distinct REF_FREQUENCY from $( ls -d ${RUNDIR}/Input/*${OBSID}*SB* )::SPECTRAL_WINDOW"| singularity exec -B /scratch,$PWD $SIMG taql | tail -n 2 | head -n 1)
