...
singularity exec /cvmfs/softdrive.nl/fsweijen/singularity/lofar_kern.simg python  ${JOBDIR}/GRID_PiCaS_Launcher/update_token_status.py ${PICAS_DB} ${PICAS_USR} ${PICAS_USR_PWD} ${TOKEN} 'running'
run_disc_pipeline
stop_profile
